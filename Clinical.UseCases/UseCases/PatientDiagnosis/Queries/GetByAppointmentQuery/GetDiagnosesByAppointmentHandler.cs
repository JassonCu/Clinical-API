...
{
    public class GetDiagnosesByAppointmentHandler : IRequestHandler<GetDiagnosesByAppointmentQuery, BaseResponse<IEnumerable<GetAllDiagnosisResponseDto>>>
    {
        private readonly IUnitOfWork _unitOfWork;
        private readonly IMapper _mapper;

        public GetDiagnosesByAppointmentHandler(IUnitOfWork unitOfWork, IMapper mapper)
        {

...
public class CreateExamResultHandler : IRequestHandler<CreateExamResultCommand, BaseResponse<bool>>
{
    ...
    public async Task<BaseResponse<bool>> Handle(CreateExamResultCommand request, CancellationToken cancellationToken)
    {
        ...
        try
        {
            ...
            response.Data = await _unitOfWork.ExamResult.ExecAsync(StoreProcedures.uspExamResultRegister, parameters);

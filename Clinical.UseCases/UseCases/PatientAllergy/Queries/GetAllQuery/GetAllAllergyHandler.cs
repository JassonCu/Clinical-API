...
{
    public class GetAllAllergyHandler : IRequestHandler<GetAllAllergyQuery, BaseResponse<IEnumerable<GetAllAllergyResponseDto>>>
    {
        private readonly IUnitOfWork _unitOfWork;
        private readonly IMapper _mapper;

        public GetAllAllergyHandler(IUnitOfWork unitOfWork, IMapper mapper)
        {
